...
from .views import DiscView, ArtistsView, DiscDetail, ArtistDetail, HomeView, artist, UpdateArtistView
...
urlpatterns = [
    ...
    path('edit-artist/<int:pk>', UpdateArtistView.as_view(), name='edit-artist'),
]
